...
from lib.bbox.bbox_transform import bbox_pred, clip_boxes, filter_boxes
...
def pred_eval(predictor, test_data, imdb, cfg, vis=True, thresh=1e-3,
        ...
        for data_batch in test_data:
            ...
            for delta, (scores, boxes, masks, data_dict) in enumerate(
                ...
                if True:
                    ...
                    vis_all_mask(data_dict['data'].asnumpy(), boxes_this_image, masks_this_image, imdb.classes,
                                 scales[delta], cfg)
