...
class Module(BaseModule):
    ...
    def bind(self, data_shapes, label_shapes=None, for_training=True,
        ...
        self._data_shapes, self._label_shapes = zip(*[_parse_data_desc(self.data_names,
                                                                       self.label_names,
                                                                       data_shape,
                                                                       label_shape)
...
class MutableModule(BaseModule):
    ...
    def bind(self, data_shapes, label_shapes=None, for_training=True,
        ...
        module = Module(self._symbol, self._data_names, self._label_names, logger=self.logger,
                        ...
                        fixed_param_names=self._fixed_param_names)
        data_shapes = [max_data_shapes for _ in range(len(self._context))]
        label_shapes = [max_label_shapes for _ in range(len(self._context))]
