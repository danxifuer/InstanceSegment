...
def parse_args():
    ...
    parser.add_argument('--cfg',
                        ...
                        default='/home/daiab/machine_disk/projects/FCIS/experiments'
                                '/fcis/cfgs/nuclei_end2end.yaml',
    ...
    parser.add_argument('--frequent', help='frequency of logging',
                        default=config.default.frequent, type=int)
...
sys.path.insert(0, os.path.join(curr_path,
                                '../external/mxnet', config.MXNET_VERSION))
...
from fcis.core import callback, metric
from fcis.core.loader import AnchorLoader
from fcis.core.module import MutableModule
from lib.utils.create_logger import create_logger
from lib.utils.load_data import load_gt_sdsdb, merge_roidb, filter_roidb
