...
import mxnet as mx
from fcis.function.test_fcis import test_fcis
...
def main():
    ...
    test_fcis(config, config.dataset.dataset,
              ...
              args.vis, args.ignore_cache,
              args.shuffle, config.TEST.HAS_RPN,
              config.dataset.proposal, args.thresh,
