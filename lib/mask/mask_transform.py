...
from lib.nms.nms import py_nms_wrapper, gpu_nms_wrapper, cpu_nms_wrapper
from lib.mask.gpu_mv import mv as mask_voting_kernel
...
def get_gt_masks(gt_mask_file, size):
    ...
    gt_masks = pickle.load(open(gt_mask_file, 'rb'))
